    ...
    public function collectItems(BASE_CLASS_ConsoleItemCollector $event)
    {
        ...
        if (OW::getUser()->isAuthenticated()) {
            ...
            OW::getDocument()->addOnloadScript("
                document.getElementById('".$item->getUniqId()."').addEventListener('click', function() { new OW_FloatBox({ \$contents: $('#base_cmp_floatbox_ajax_signin') }); document.getElementById('input_base_identity').focus(); })
            ");
