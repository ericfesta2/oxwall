...
class BOL_SearchService
{
    ...
    public function saveSearchResult( array $idList )
    {
        ...
        $event = new OW_Event('base.after_save_search_result', array('searchDto' => $search, 'userIdList' => $idList), []);
    ...
    public function updateSearchResult( $id, array $idList )
    {
        ...
        $event = new OW_Event('base.after_update_search_result', array('userIdList' => $idList), []);
        OW::getEventManager()->trigger($event);
