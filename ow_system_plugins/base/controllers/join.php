...
class JoinForm extends BASE_CLASS_UserQuestionForm
{
    ...
    protected bool $displayAccountType = false;
    public array $questions = [];
    protected array $sortedQuestionsList = [];
    protected array $questionListBySection = [];
    protected array $questionValuesList = [];
    ...
    {
        $this->questions = $this->isLastStep ?
            BOL_QuestionService::getInstance()->findSignUpQuestionsForAccountType($this->accountType) :
            BOL_QuestionService::getInstance()->findBaseSignUpQuestions();
    }
