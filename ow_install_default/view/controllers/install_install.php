...
<form method="post">
    ...
    <p style="text-align:center"><input type="submit" value="Continue" name="continue" style=" margin-bottom: 19px; text-transform: uppercase; font-size: 13px; font-weight: bold; color: #777;" /></p>
</form>