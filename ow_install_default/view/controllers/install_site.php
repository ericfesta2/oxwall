...
<form method="post">
	<table class="form">
	    ...
	    <tr>
	        ...
	        <td class="description">A catchy, one-line site <br>description (optional)</td>
	    </tr>
	    <tr>
	    ...
	    <tr style="color: #626262; font-size: 15px; padding-bottom: 24px;">
			<th colspan="3">Site Administrator</th>
		</tr>
	    <tr>
