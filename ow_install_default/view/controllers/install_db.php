...
<p style=" color: #626262; text-align: center;">
...
<form method="post">
    <table class="form">
        <tr> 
            ...
            <td class="description">
                MySQL server host and optionally port. Example: <i>localhost</i> or <i>localhost:3307</i>
            </td>
        </tr>
        <tr>
    ...
    <p style="text-align:center;margin: 10px 0 20px 0;">
        <input type="submit" value="Continue"
            style="text-transform: uppercase; font-size: 13px; font-weight: bold; color: #777;" />
    </p>
</form>
