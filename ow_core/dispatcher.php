...
class OW_Dispatcher
{
    ...
    public function dispatch()
    {
        ...
        try
        {
            ...
            $action->invokeArgs($controller, array(self::ATTRS_KEY_VARLIST => ( empty($this->dispatchAttributes[self::ATTRS_KEY_VARLIST]) ? [] : $this->dispatchAttributes[self::ATTRS_KEY_VARLIST] )));
        }
        catch ( Exception $e )
        {
            throw new Redirect404Exception();
