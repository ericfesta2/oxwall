...
class Form
{
    ...
    const string ENCTYPE_MULTYPART_FORMDATA = 'multipart/form-data';
    const string BIND_SUCCESS = 'success';
    const string BIND_SUBMIT = 'submit';
    const string AJAX_DATA_TYPE_SCRIPT = 'script';
    /* -------------------------------------------------------------------------------------------------------------- */
    const string ELEMENT_CSRF_TOKEN = 'csrf_token';
    const string ELEMENT_FORM_NAME = 'form_name';
     ...
     * @return Form
     */
    public function setAjaxResetOnSuccess( bool $resetForm )
    {
