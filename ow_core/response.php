...
class OW_Response
{
     ...
     */
    const string HD_CNT_TYPE = 'Content-Type';
    private const string HD_CACHE_CONTROL = 'Cache-Control';
    private const string HD_CNT_DISPOSITION = 'Content-Disposition';
    private const string HD_CNT_LENGTH = 'Content-Length';
    private const string HD_CONNECTION = 'Connection';
    private const string HD_PRAGMA = 'Pragma';
    private const string HD_EXPIRES = 'Expires';
    private const string HD_LAST_MODIFIED = 'Last-Modified';
    private const string HD_LOCATION = 'Location';
