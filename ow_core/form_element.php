...
{
    const string ATTR_DISABLED = 'disabled';
    const string ATTR_CLASS = 'class';
    const string ATTR_MAXLENGTH = 'maxlength';
    const string ATTR_CHECKED = 'checked';
    const string ATTR_READONLY = 'readonly';
    const string ATTR_SIZE = 'size';
    const string ATTR_SELECTED = 'selected';
...
class DateField extends FormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        for ( $i = 1; $i <= $lastDay; $i++ )
        {
            $attrs = (isset($this->defaultDate['day']) && (string) $i === (string) $this->defaultDate['day']) ? array('selected' => 'selected') : [];
...
class Selectbox extends InvitationFormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        foreach ( $this->options as $key => $value )
        {
            $attrs = ($this->value !== null && (string) $key === (string) $this->value) ? array('selected' => 'selected') : [];
...
class TagsField extends FormElement
{
    ...
    public function __construct( $name, $id = '', $tags = [] )
    {
        parent::__construct($name, $id);
        $this->tags = $tags;
...
class AgeRange extends FormElement implements DateRangeInterface
{
    ...
    public function renderInput( $params = null )
    {
        ...
        {
            $fromAgeAttrs = ((string) $i === (string) $defaultAgeFrom) ? array('selected' => 'selected') : [];
            $toAgeAttrs = ((string) $i === (string) $defaultAgeTo) ? array('selected' => 'selected') : [];
...
//    }
    ...
    public function renderInput( $params = null )
    {
        ...
        {
            $fromValueAttrs = ((string) $i === (string) $defaultValueFrom) ? array('selected' => 'selected') : [];
            $toValueAttrs = ((string) $i === (string) $defaultValueTo) ? array('selected' => 'selected') : [];
...
class YearRange extends FormElement implements DateRangeInterface
{
    ...
    public function renderInput( $params = null )
    {
        ...
        {
            $fromYearAttrs = ((string) $i === (string) $defaultYearFrom) ? array('selected' => 'selected') : [];
            $toYearAttrs = ((string) $i === (string) $defaultYearTo) ? array('selected' => 'selected') : [];
...
class MobileWysiwygTextarea extends Textarea
{
     ...
     * @param array $buttons
     */
    public function __construct( $name, $id = '',  $pluginKey = 'blog', array $buttons = [] )
    {
        parent::__construct($name, $id);
